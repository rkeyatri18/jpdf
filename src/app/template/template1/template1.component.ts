import { Component, ComponentFactoryResolver, ContentChildren, ElementRef, Input, OnChanges, OnInit, QueryList, Renderer2, SimpleChanges, ViewChild } from '@angular/core';
...
export class Template1Component implements OnChanges, OnInit {
