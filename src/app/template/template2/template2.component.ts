...
downloadPdf() { 
  ...
  pdf.addImage('https://images.unsplash.com/photo-1554620121-59e7f3f6e3a4', 'JPEG', 1, 1, 2.5, 2.5)   
  pdf.html(el, {
    margin: [25, 15, 30, 5], 
    callback: (pdf) => { 
...
downloadImage() {
  ...
  downloadByUrl() { 
    ...
    var h ="<!DOCTYPE html><head><link href='https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css'  rel='stylesheet'> <link href='http://pdf.rbntechnologies.com/content/style.css' rel='stylesheet'>";
    h+="<link href='https://fonts.googleapis.com/css2?family=Lato:wght@300;400;700&family=Poppins:wght@300;400;500;600;700&display=swap' rel='stylesheet'>  </head> @html  <body>";
    h = h.replace('@html',html);
    var d = { Html: h, FileName: "test.pdf" }; 
    console.log(d)
  ...
  downloadReport(reportName, data) { 
    var bytes = this._base64ToArrayBuffer(data); 
